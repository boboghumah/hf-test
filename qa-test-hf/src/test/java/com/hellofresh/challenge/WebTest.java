...
public class WebTest {
	 ...
	 *         "src/test/resources/chromedriver"); driver = new ChromeDriver(); wait
	 ...
	 * 
	 *       String timestamp = String.valueOf(new Date().getTime()); String email =
	 *       "hf_challenge_" + timestamp + "@hf" + timestamp.substring(7) + ".com";
	 *       String name = "Firstname"; String surname = "Lastname";
	 ...
	 *       driver.findElement(By.id("passwd")).sendKeys("Qwerty"); Select select =
	 *       new Select(driver.findElement(By.id("days")));
	 *       select.selectByValue("1"); select = new
	 *       Select(driver.findElement(By.id("months"))); select.selectByValue("1");
	 ...
	 *       driver.findElement(By.id("city")).sendKeys("Qwerty"); select = new
	 ...
	 *       driver.findElement(By.id("submitAccount")).click(); WebElement heading
	 *       =
	 ...
	 * 
	 * @Test public void logInTest() { String fullName = "Joe Black";
	 *       wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("login"))).click();
	 *       driver.findElement(By.id("email")).sendKeys(existingUserEmail);
	 *       driver.findElement(By.id("passwd")).sendKeys(existingUserPassword);
	 *       driver.findElement(By.id("SubmitLogin")).click(); WebElement heading =
	 *       wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("h1")));
	 * 
	 *       assertEquals("MY ACCOUNT", heading.getText()); assertEquals(fullName,
	 ...
	 * 
	 *       wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='layer_cart']//a[@class
	 *       and @title='Proceed to checkout']"))).click();
	 * 
	 *       wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(@class,'cart_navigation')]/a[@title='Proceed
	 *       to checkout']"))).click();
	 ...
	 *       assertTrue(driver.findElement(By.xpath("//li[@class='step_done
	 *       step_done_last four']")).isDisplayed());
	 *       assertTrue(driver.findElement(By.xpath("//li[@id='step_end'
	 *       and @class='step_current last']")).isDisplayed());
	 *       assertTrue(driver.findElement(By.xpath("//*[@class='cheque-indent']/strong")).getText().contains("Your
